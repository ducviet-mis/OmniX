...
export function Grades() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal isOpen={isAddingSubject} onClose={() => setIsAddingSubject(false)} title="Thêm môn học mới">
        <form onSubmit={handleAddSubject} className="space-y-4">
          ...
          <div className="flex justify-end gap-2 mt-6">
            <button type="button" onClick={() => setIsAddingSubject(false)} className="px-4 py-2 border border-slate-300 text-slate-700 rounded-md hover:bg-slate-100 font-medium">Hủy</button>
            <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium">Thêm môn</button>
          </div>
        </form>
      </Modal>
