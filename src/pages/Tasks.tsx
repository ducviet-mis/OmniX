...
export function Tasks() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <Modal isOpen={isAdding} onClose={() => setIsAdding(false)} title="Thêm bài tập mới">
        <form onSubmit={handleAddTask} className="space-y-4">
          <div>
            ...
            <input
              ...
              autoFocus
              required
              placeholder="VD: Làm đề cương ôn tập..."
              value={newTaskTitle}
          ...
          <div className="flex justify-end gap-2 mt-6">
            <button type="button" onClick={() => setIsAdding(false)} className="px-4 py-2 text-slate-600 border border-slate-300 hover:bg-slate-100 rounded-md font-medium">Hủy</button>
            <button type="submit" className="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium">Lưu</button>
          </div>
        </form>
      </Modal>
